...
#ifndef NAMESPACE_CALC
#define NAMESPACE_CALC
...
namespace Calculadora {
	...
	// Getters and Setters
	//
	std::string getDisplayStack() {
		return displayStack;
	}
	void setDisplayStack(std::string& texto) {
		displayStack = texto;
	}

	//
	// Demais funções a serem implementadas por fora
	//
	String^ _charToWinT(const char* texto);
	String^ _stringToWinT(std::string& texto);
	...
	private: System::Windows::Forms::TextBox^  textAux;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textAux = (gcnew System::Windows::Forms::TextBox());
			this->SuspendLayout();
			// 
			// display
			// 
			...
			this->display->Click += gcnew System::EventHandler(this, &FormCalc::display_Click);
			// 
			// btn_res
			// 
			...
			this->btn_0->Click += gcnew System::EventHandler(this, &FormCalc::btn_0_Click);
			// 
			// btn_dot
			// 
			...
			this->btn_dot->Click += gcnew System::EventHandler(this, &FormCalc::btn_dot_Click);
			// 
			// btn_div
			// 
			...
			this->btn_2->Click += gcnew System::EventHandler(this, &FormCalc::btn_2_Click);
			// 
			// btn_3
			// 
			...
			this->btn_3->Click += gcnew System::EventHandler(this, &FormCalc::btn_3_Click);
			// 
			// btn_mul
			// 
			...
			this->btn_4->Click += gcnew System::EventHandler(this, &FormCalc::btn_4_Click);
			// 
			// btn_5
			// 
			...
			this->btn_5->Click += gcnew System::EventHandler(this, &FormCalc::btn_5_Click);
			// 
			// btn_6
			// 
			...
			this->btn_6->Click += gcnew System::EventHandler(this, &FormCalc::btn_6_Click);
			// 
			// btn_min
			// 
			...
			this->btn_7->Click += gcnew System::EventHandler(this, &FormCalc::btn_7_Click);
			// 
			// btn_8
			// 
			...
			this->btn_8->Click += gcnew System::EventHandler(this, &FormCalc::btn_8_Click);
			// 
			// btn_9
			// 
			...
			this->btn_9->Click += gcnew System::EventHandler(this, &FormCalc::btn_9_Click);
			// 
			// btn_plus
			// 
			...
			this->btn_perc->Click += gcnew System::EventHandler(this, &FormCalc::btn_perc_Click);
			// 
			// btn_sqrt
			// 
			...
			// btn_del
			// 
			this->btn_del->BackColor = System::Drawing::Color::AliceBlue;
			...
			this->btn_cleare->Click += gcnew System::EventHandler(this, &FormCalc::btn_cleare_Click);
			// 
			// btn_clear
			// 
			...
			this->rb_rad->CheckedChanged += gcnew System::EventHandler(this, &FormCalc::rb_rad_CheckedChanged);
			// 
			// rb_deg
			// 
			...
			this->rb_deg->CheckedChanged += gcnew System::EventHandler(this, &FormCalc::rb_deg_CheckedChanged);
			// 
			// textAux
			// 
			this->textAux->BackColor = System::Drawing::SystemColors::Window;
			this->textAux->BorderStyle = System::Windows::Forms::BorderStyle::None;
			this->textAux->Font = (gcnew System::Drawing::Font(L"Lucida Console", 16));
			this->textAux->Location = System::Drawing::Point(18, 19);
			this->textAux->Name = L"textAux";
			this->textAux->ReadOnly = true;
			this->textAux->Size = System::Drawing::Size(106, 24);
			this->textAux->TabIndex = 1;
			this->textAux->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &FormCalc::textAux_KeyDown);
			// 
			// FormCalc
			// 
			...
			this->Controls->Add(this->textAux);
...
#pragma endregion
	...
	public:
		...
		*/
		...
		std::string _wCharToString(wchar_t wideStr);


	private: 
		void SetFocusOnTextAux() {
			textAux->Focus();
		}
		...
		System::Void textAux_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) {
			...
			if (e->KeyCode == Keys::Back) {
				...
				if (key >= 96 && key <= 105) {
					...
					char keyb[2];
					std::sprintf(keyb, "%c", key);
					pushSymbol(keyb);
					setDisplay();
				}
				//else if (key == 110) // virgula (melhor não fazer)
				//	key = 46; // ponto
				//else if (key == 61) // igual (Keys::Oemplus)
				//TODO chamar função do igual
			}
		}
